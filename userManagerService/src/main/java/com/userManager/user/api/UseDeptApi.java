...
public interface UseDeptApi{
     ...
     * @return
     */
    @GetMapping(value = "/innerApi/useDeptApi/getById")
     ...
     * @return
     */
    @DeleteMapping(value = "/innerApi/useDeptApi/removeById")
     ...
     * @return
     */
    @PutMapping(value = "/innerApi/useDeptApi/save")
     ...
     * @return
     */
    @PostMapping(value = "/innerApi/useDeptApi/updateById")
     ...
     * @return
     */
    @GetMapping(value = "/innerApi/useDeptApi/select")
     ...
     * @return
     */
    @GetMapping(value = "/innerApi/useDeptApi/getPage")
